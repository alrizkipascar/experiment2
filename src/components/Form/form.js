  ...
  return (
    <div className="max-w-2xl mx-auto pb-20 lg:pb-10 ">
      ...
      >
        ...
        <button
          type="submit"
          className="text-white bg-secondary hover:bg-background focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-accent dark:hover:bg-background dark:focus:ring-background"
        >
          Submit
        </button>
      </form>
